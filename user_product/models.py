...
class Order(models.Model):
    user = models.ForeignKey(AdvUser, blank=True, null=True,
...
class Feedback(models.Model):
    user = models.ForeignKey(AdvUser, on_delete=models.CASCADE,
                             verbose_name='Пользователь', related_name='users')
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, verbose_name='Продукт', related_name='feedbacks')
    ...
    created_at = models.DateTimeField(
        auto_now=True, verbose_name='Дата создания отзыва')
...
class FeedbackImage(models.Model):
    """
    Модель группы избранных товаров для одного пользователя
    """
    feedback = models.ForeignKey(
        Feedback, on_delete=models.CASCADE, related_name='images', verbose_name='Ответы')
    image = models.FileField(
        upload_to='feedbacks/%Y/%m/%d/', verbose_name='Изображения')
...
class FavouritesItem(models.Model):
    ...
    favourites = models.ForeignKey(
        Favourites, on_delete=models.CASCADE, verbose_name='Избранное', related_name='items')
    product = models.ForeignKey(Product, on_delete=models.CASCADE,
                                verbose_name='Товар', related_name='favourites_items')
