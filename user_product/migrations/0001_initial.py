# Generated by Django 3.1 on 2022-04-20 16:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='items', to='user_product.order', verbose_name='Заказ')),
