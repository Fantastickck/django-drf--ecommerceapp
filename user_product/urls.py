...
urlpatterns = [
    ...
    path('favourites/add/<int:product_id>/', AddFavouritesItem.as_view(), name='add_favourites_item'),
    path('favourites/remove/<int:item_id>', RemoveFavouritesItem.as_view(), name='remove_favourite_item')
]
